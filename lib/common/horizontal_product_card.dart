...
import 'package:online_nursery_plant_shop/common/product_cart_controller.dart';
          ...
          children: [
              ...
              itemBuilder: (_, index) =>  GestureDetector(
                onTap: () => Get.to(() =>  Addtocart(
                  sellerId: controller.productDataList[index]['userId'],
                              ...
                              children: [
                                ...
                                Positioned(
                                  ...
                                  child: TRoundedContainer(
                                    radius: TSizes.md,
                                    backgroundColor:
                                        Color.fromARGB(255, 255, 213, 0).withOpacity(0.8),
