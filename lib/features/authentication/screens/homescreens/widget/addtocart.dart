...
import 'package:online_nursery_plant_shop/features/authentication/screens/homescreens/widget/checkout_pro.dart';
...
import 'package:online_nursery_plant_shop/features/authentication/screens/product_details/widgets/product_image_slider.dart';
...
class Addtocart extends StatelessWidget {
  const Addtocart({
    ...
    required this.productId, required this.sellerId, 
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Text(_counterController.counter.value.toString(),
                                        style: Theme.of(context)
                                            .textTheme
                                            .titleSmall),
                                    const SizedBox(
                                    ...
                                    TProductPRice(
                                      price: _counterController.counter.value != 0
                                          ? discountedPrice * _counterController.counter.value
                                          : discountedPrice,
                                      islarge: true,
                                    ),
                                  ],
...
addToCart(productId: productId, image: image, productName: productName, productPrice: productPrice, productDescription: productDescription, productCategory: productCategory, productQuantity: productQuantity, sellerName: sellerName, discount: discount, selectedQuantity: _counterController.counter.value,sellerId: sellerId);
                            Get.to(() =>  CheckoutScreenMain(
                              ...
                              discount: discount,
                              selectedQuantity: _counterController.counter.value,
                              sellerId: sellerId,
