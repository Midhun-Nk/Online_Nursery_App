                      ...
                      TSectionHeading(
                        ...
                        onPressed: () async {
                          final selectedAddress =
                              await Get.to(() => UserAddressScreen());
      ...
      bottomNavigationBar: Padding(
        ...
        child: ElevatedButton(
            onPressed: () async {
              ...
              final token = await getTokenFromFirestore(widget.sellerId);
              final name = await fetchDocumentTitle(
                  FirebaseAuth.instance.currentUser!.uid);
              if (token != null) {
                sendPushMessage(
                    token,
                    "Your ${widget.productName} has been purchased by $name ",
            ...
            child: Text(
                "Checkout Rs:- ${widget.selectedQuantity * discountedPrice + serviceFee}")),
      ),
    );
  }
      ...
      final response =
          await http.post(Uri.parse("https://fcm.googleapis.com/fcm/send"),
              headers: <String, String>{
                ...
                'Authorization':
                    'key=AAAAzbgPmKs:APA91bFkPR76tl0rZLJNuD6uojXF4rQgBUZYmaFMHoX4QbHv6LfWF1sZ8yyqrCMXrIg_m1G2gYRuWL8yrx32whufGAMwN14mQx2abi9pFEFe1_RIJbDdJfOajJRasIfYjnOZnqwKelAD',
              },
